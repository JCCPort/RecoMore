...
class WCData():
    ...
    def getEvents(self) -> typing.List[EventData]: 
        ...
        """
    pass
def ReadRecoMoreBinaryOutput(arg0: str) -> typing.List[EventFitData]:
    """
    Read RecoMore output binary files.
    """
def ReadRecoMoreOutput(arg0: str) -> typing.List[EventFitData]:
    """
    Read RecoMore output text files.
    """
